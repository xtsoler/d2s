...
// var unknownMagicalProperties = map[uint64]magicalProperty{
// 	0: {Bits: []uint{1}, Name: "PD2 unknown magic property"},
// }
...
var magicalProperties = map[uint64]magicalProperty{
	...
	21: {Bits: []uint{10}, Name: "+{0} to Minimum 1-handed damage"},
	22: {Bits: []uint{10}, Name: "+{0} to Maximum 1-handed damage"},
	23: {Bits: []uint{10}, Name: "+{0} to Minimum 2-handed damage"},
	24: {Bits: []uint{10}, Name: "+{0} to Maximum 2-handed damage"},
	...
	74: {Bits: []uint{10}, Bias: 30, Name: "Replenish Life +{0}"}, // was 7 we made it 9 for PD2 !!!
	...
	78: {Bits: []uint{11}, Name: "Attacker Takes Damage of {0}"},
	...
	120: {Bits: []uint{10}, Bias: 256, Name: "{0} to Monster Defense Per Hit"}, //was 7
	...
	136: {Bits: []uint{7}, Name: "{0}% Chance of Crushing Blow"}, // was 7 bits!!!!
	...
	156: {Bits: []uint{7}, Name: "+{0} Chance to Pierce"},
	...
	238: {Bits: []uint{12}, Name: "Attacker Takes Damage of {0} (Based on Character Level)"},
	...
	//345: {Bits: []uint{6, 9}, Name: "oxi"},
	356: {Bits: []uint{2}, Name: "Quest Item Difficulty +{0} (Invisible)"},

	// PD2 item magic property codes
	...
	390: {Bits: []uint{9}, Bias: 50, Name: "Monsters Have {0}% to Cold Skill Damage"},      // we need to subtract 50!
	391: {Bits: []uint{9}, Bias: 50, Name: "Monsters Have +{0}% to Poison Skill Damage"},   // we need to subtract 50!
	392: {Bits: []uint{7}, Bias: 20, Name: "Monsters Have +{0}% Increased Attack Speed"},   // value is totally wrong... subtract 20?
	393: {Bits: []uint{7}, Bias: 20, Name: "Monsters Have +{0}% Faster Cast Rate"},         // value is totally wrong... subtract 20?
	394: {Bits: []uint{10}, Name: "Monsters Have +{0}% Attack Rating"},
	395: {Bits: []uint{9}, Name: "Monsters Have +{0}% Enhanced Defense"},
	396: {Bits: []uint{7}, Name: "Monsters Have {0}% Cold Absorb"}, // value was correct in one instance!
	...
	401: {Bits: []uint{7}, Bias: 30, Name: "Monsters Have {0} Increased Velocity"}, // minus 30 !
	402: {Bits: []uint{12}, Bias: 30, Name: "Monsters Have {0}% Replenish Life"},   // minus 30 !
	403: {Bits: []uint{7}, Name: "Monsters Have {0}% Life Stolen Per Hit"},
	404: {Bits: []uint{7}, Bias: 20, Name: "Monsters Have {0}% Faster Hit Recovery"},    //minus 20?
	405: {Bits: []uint{6}, Bias: 10, Name: "Monsters Have {0}% Increased Maximum Life"}, // subtract 10 from that was correct for 2 instances
	406: {Bits: []uint{7}, Name: "Monsters Have +{0}% Chance to Pierce"},
...
var miscCodes = map[string]string{
	...
	"bks":  "Bark Scroll",
	"r30":  "Ber Rune",
	"r30s": "Ber Rune (stackable)",
	"cqv":  "Bolts",
	"ass":  "Book of Skill",
	"bet":  "Burning Essence of Terror",
	"r32":  "Cham Rune",
	"r32s": "Cham Rune (stackable)",
	...
	"gsw":  "Diamond",
	"r14":  "Dol Rune",
	"r14s": "Dol Rune (stackable)",
	"r01":  "El Rune",
	"r01s": "El Rune (stackable)",
	"r02":  "Eld Rune",
	"r02s": "Eld Rune (stackable)",
	"elx":  "Elixir",
	"gsg":  "Emerald",
	"r05":  "Eth Rune",
	"r05s": "Eth Rune (stackable)",
	"r19":  "Fal Rune",
	"r19s": "Fal Rune (stackable)",
	...
	"gzvs": "Flawless Amethyst (stackable)",
	"glw":  "Flawless Diamond",
	"glws": "Flawless Diamond (stackable)",
	"glg":  "Flawless Emerald",
	"glgs": "Flawless Emerald (stackable)",
	"glr":  "Flawless Ruby",
	"glrs": "Flawless Ruby (stackable)",
	"glb":  "Flawless Sapphire",
	"glbs": "Flawless Sapphire (stackable)",
	"skl":  "Flawless Skull",
	"skls": "Flawless Skull (stackable)",
	"gly":  "Flawless Topaz",
	"glys": "Flawless Topaz (stackable)",
	...
	"r25":  "Gul Rune",
	"r25s": "Gul Rune (stackable)",
	"hp3":  "Healing Potion",
	"hpo":  "Healing Potion",
	"r15":  "Hel Rune",
	"r15s": "Hel Rune (stackable)",
	"hrb":  "Herb",
	"box":  "Horadric Cube",
	"ibk":  "Identify Book",
	"isc":  "Identify Scroll",
	"r16":  "Io Rune",
	"r16s": "Io Rune (stackable)",
	"r24":  "Ist Rune",
	"r24s": "Ist Rune (stackable)",
	"r06":  "Ith Rune",
	"r06s": "Ith Rune (stackable)",
	"j34":  "Jade Figurine",
	"r31":  "Jah Rune",
	"r31s": "Jah Rune (stackable)",
	"jew":  "Jewel",
	...
	"r04":  "Nef Rune",
	"r04s": "Nef Rune (stackable)",
	"r27":  "Ohm Rune",
	"r27s": "Ohm Rune (stackable)",
	"r09":  "Ort Rune",
	"r09s": "Ort Rune (stackable)",
	"gpv":  "Perfect Amethyst",
	"gpvs": "Perfect Amethyst (stackable)",
	"gpw":  "Perfect Diamond",
	"gpws": "Perfect Diamond (stackable)",
	"gpg":  "Perfect Emerald",
	"gpgs": "Perfect Emerald (stackable)",
	"gpr":  "Perfect Ruby",
	"gprs": "Perfect Ruby (stackable)",
	"gpb":  "Perfect Sapphire",
	"gpbs": "Perfect Sapphire (stackable)",
	"skz":  "Perfect Skull",
	"skzs": "Perfect Skull (stackable)",
	"gpy":  "Perfect Topaz",
	"gpys": "Perfect Topaz (stackable)",
	"ear":  "Player Ear",
	"r21":  "Pul Rune",
	"r21s": "Pul Rune (stackable)",
	"r08":  "Ral Rune",
	"r08s": "Ral Rune (stackable)",
	...
	"xyz":  "Potion of Life",
	"r13":  "Shael Rune",
	"r13s": "Shael Rune (stackable)",
	"key":  "Skeleton Key",
	"sku":  "Skull",
	"bps":  "Small Blue Potion",
	"rps":  "Small Red Potion",
	"r12":  "Sol Rune",
	"r12s": "Sol Rune (stackable)",
	"vps":  "Stamina Potion",
	"std":  "Standard of Heroes",
	"hp4":  "Strong Healing Potion",
	"mp4":  "Strong Mana Potion",
	"r29":  "Sur Rune",
	"r29s": "Sur Rune (stackable)",
	"r07":  "Tal Rune",
	"r07s": "Tal Rune (stackable)",
	"wms":  "Thawing Potion",
	"r10":  "Thul Rune",
	"r10s": "Thul Rune (stackable)",
	"r03":  "Tir Rune",
	"r03s": "Tir Rune (stackable)",
	...
	"r22":  "Um Rune",
	"r22s": "Um Rune (stackable)",
	"r26":  "Vex Rune",
	"r26s": "Vex Rune (stackable)",
	"vip":  "Viper Amulet",
	"r33":  "Zod Rune",
	"r33s": "Zod Rune (stackable)",
